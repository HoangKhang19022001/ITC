  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar os-host os-theme-light os-host-resize-disabled os-host-scrollbar-horizontal-hidden os-host-transition os-host-overflow os-host-overflow-y"><div class="os-resize-observer-host observed"><div class="os-resize-observer" style="left: 0px; right: auto;"></div></div><div class="os-size-auto-observer observed" style="height: calc(100% + 1px); float: left;"><div class="os-resize-observer"></div></div><div class="os-content-glue" style="margin: 0px -8px; width: 249px; height: 590px;"></div><div class="os-padding"><div class="os-viewport os-viewport-native-scrollbars-invisible os-viewport-native-scrollbars-overlaid" style="overflow-y: scroll;"><div class="os-content" style="padding: 0px 8px; height: 100%; width: 100%;">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="indexgiangvien.php" class="d-block"><?php echo $p->laycot("SELECT TenDangNhap FROM taikhoan WHERE MaTK = '$layid_dangnhap' LIMIT 1");?></a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            <a href="indexhocvien.php" class="nav-link active">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="Tailieuhoctap.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Tài tiệu học tập</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="Xemlichthi.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Xem lịch thi</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="Xemketquathi.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Xem kết quả thi</p>
                </a>
              </li>
          ...
          <section class="col-lg-12 connectedSortable ui-sortable">
            ...
            <div class="card">
              ...
              <form action="" method="post" style="text-align: center;">
                <caption><strong style="color: deepskyblue; padding-top: 40px;padding-bottom: 40px; font-size: 30px; font-family: 'Times New Roman', Times, serif; text-indent: 20px;">Form đăng ký khóa học</strong></caption><br>
                <div>
                ...
                <!-- <div>
                    <input type="date"  name="form-ngaysinh" id="form-ngaysinh" placeholder="Ngày sinh" style="height: 40px; min-width: 400px; margin-top: 40px; border: 3px double navy; border-top-style: hidden; border-left-style: hidden; border-right-style: hidden; font-family: 'Times New Roman', Times, serif; text-align: center;"><br>
                <div id="ns"> </div>
                </div> -->
                <div>
                    <input type="date" name="form-ngaysinh" style="height: 40px; min-width: 400px; margin-top: 40px; border: 3px double navy; border-top-style: hidden; border-left-style: hidden; border-right-style: hidden; font-family: 'Times New Roman', Times, serif;  text-align: center;" id="form-ngaysinh" placeholder="Ngày sinh" > <br>
                ...
                <div>
                    <input type="text"  name="form-diachi" id="form-diachi" placeholder="Địa chỉ hiện tại" style="height: 40px; min-width: 400px; margin-top: 40px; border: 3px double navy; border-top-style: hidden; border-left-style: hidden; border-right-style: hidden; font-family: 'Times New Roman', Times, serif; text-align: center;"><br>
                <div id="dc"style="color: red;"></div>
                  </div>
                <div>
                    <input type="submit" value="Đăng ký" id="btn-themnguoidung" name="btn-themnguoidung" class="btn btn-primary float-right>
                    <div id=""></div>
                </div>
            </form>
            <?php
                    			switch($_POST['btn-themnguoidung'] ?? null)
                                {
                                    ...
                                    { 
                                        ...
                                        $makh = $_GET['id'];
                                        if($tennguoidung != '' && $ngaysinh != '' && $sdt != '' && $email != '' && $diachi != ''&& $makh != '')
                                        {
                                           
                                            if($p->themxoasua("INSERT INTO HocVienDK(TenHV,Ngaysinh,SDT,Email,Diachi,MaKH) VALUES('$tennguoidung','$ngaysinh','$sdt','$email','$diachi','$makh')")==1)
                                            {
                                                echo '<script> alert("Đăng ký Khóa Học Thành Công");</script>';
                                                header( "refresh:0;url=indexhocvien.php" );
                                            }
                                            else
                                            {
                                                echo '<script> alert("Đăng ký Khóa Học Không Thành Công. Vui lòng kiểm tra lại thông tin người dùng");</script>';
                                            }
                                        }
                                        else
                                        {
