  ...
  <div class="content-wrapper" style="min-height: auto;">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Danh sách QLDT</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
          </div><!-- /.col -->
        </div><!-- /.row -->
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row">
        <?php
                $p ->load_dsnguoidungQLDT("SELECT * FROM QuanLyDaoTao order by MaQLDT desc");
        ?>
          <!-- ./col -->
        </div>
        <!-- /.row -->
  ...
  <div class="content-wrapper" style="min-height: auto;">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Danh sách học viên</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
          </div><!-- /.col -->
        </div><!-- /.row -->
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row">
        <?php
            $p ->load_dsnguoidungHV("SELECT * FROM HocVien order by MaHV desc");
        ?>
          <!-- ./col -->
        </div>
        <!-- /.row -->
  ...
  <div class="content-wrapper" style="min-height: auto;">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row">
        <?php
            $p ->load_dsnguoidungGV("SELECT * FROM GiangVien order by MaGV desc");
        ?>
          <!-- ./col -->
        </div>
        <!-- /.row -->
