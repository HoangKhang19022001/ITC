          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              <div class="inner">
                ...
                <p><?php echo $p->laycot("SELECT COUNT(MaHV) FROM hocvien"); ?></p>
              </div>
              <div class="icon">
                <i class="ion ion-bag"></i>
              </div>
              <a href="Danhsachhocvien.php" class="small-box-footer">Xem danh sách <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              <div class="inner">
                ...
                <p><?php echo $p->laycot("SELECT COUNT(MaGV) FROM giangvien"); ?></p>
              </div>
              <div class="icon">
                <i class="ion ion-stats-bars"></i>
              </div>
              <a href="Danhsachgiangvien.php" class="small-box-footer">Xem danh sách <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-warning">
              <div class="inner">
                ...
                <p><?php echo $p->laycot("SELECT COUNT(MaQLDT) FROM quanlydaotao"); ?></p>
              </div>
              <div class="icon">
                <i class="ion ion-person-add"></i>
              </div>
              <a href="DanhsachQLDT.php" class="small-box-footer">Xem danh sách <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-danger">
              <div class="inner">
                ...
                <p><?php echo $p->laycot("SELECT COUNT(MaQTV) FROM quantrivien"); ?></p>
              </div>
              <div class="icon">
                <i class="ion ion-pie-graph"></i>
              </div>
              <a href="DanhsachQTV.php" class="small-box-footer">Xem danh sách<i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
        </div>
        ...
        <div class="row">
          ...
          <section class="col-lg-12 connectedSortable ui-sortable">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <?php 
                  $p ->load_dskhoahoc1("SELECT * FROM khoahoc order by MaKH desc");
                ?>
              </div>
              <!-- /.card-body -->
            </div>
