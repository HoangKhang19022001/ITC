  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar os-host os-theme-light os-host-resize-disabled os-host-scrollbar-horizontal-hidden os-host-transition os-host-overflow os-host-overflow-y"><div class="os-resize-observer-host observed"><div class="os-resize-observer" style="left: 0px; right: auto;"></div></div><div class="os-size-auto-observer observed" style="height: calc(100% + 1px); float: left;"><div class="os-resize-observer"></div></div><div class="os-content-glue" style="margin: 0px -8px; width: 249px; height: 590px;"></div><div class="os-padding"><div class="os-viewport os-viewport-native-scrollbars-invisible os-viewport-native-scrollbars-overlaid" style="overflow-y: scroll;"><div class="os-content" style="padding: 0px 8px; height: 100%; width: 100%;">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="indexqldt.php" class="d-block"><?php echo $p->laycot("SELECT TenDangNhap FROM taikhoan WHERE MaTK = '$layid_dangnhap' LIMIT 1");?></a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            <a href="indexqldt.php" class="nav-link active">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="Quanlylophoc.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Quản lý lớp học</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="Quanlylichhoc.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Quản Lý lịch học</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="Quanlythi.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Quản lý thi</p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="Danhsachsinhviendangkykhoahoc.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Xem danh sách sinh viên DKKH</p>
                </a>
              </li>
              <li class="nav-item">
          ...
          <section class="col-lg-12 connectedSortable ui-sortable">
            ...
            <div class="card">
              ...
              <form action="" method="post">
                <caption><strong style="color: deepskyblue; padding-top: 40px;padding-bottom: 40px; font-size: 30px; font-family: 'Times New Roman', Times, serif; text-indent: 20px;">Thêm lớp học</strong></caption><br>
                <input type="text" name="form-malophoc" id="form-malophoc" placeholder="Mã Lớp Học. VD: LH0001" style="height: 40px; min-width: 400px; margin-top: 40px; border: 3px double navy; border-top-style: hidden; border-left-style: hidden; border-right-style: hidden; font-family: 'Times New Roman', Times, serif; text-align: center;"><br>
                <input type="text" name="form-tenlophoc" id="form-tenlophoc" placeholder="Tên Lớp Học" style="height: 40px; min-width: 400px; margin-top: 40px; border: 3px double navy; border-top-style: hidden; border-left-style: hidden; border-right-style: hidden; font-family: 'Times New Roman', Times, serif; text-align: center;"><br>
                <input type="number" name="form-siso" id="form-siso" placeholder="Sỉ Số Lớp" style="height: 40px; min-width: 400px; margin-top: 40px; border: 3px double navy; border-top-style: hidden; border-left-style: hidden; border-right-style: hidden; font-family: 'Times New Roman', Times, serif; text-align: center;"><br>
                <select name="form-cahoc" id="form-cahoc" style="height: 40px; min-width: 400px; margin-top: 40px; border: 3px double navy; border-top-style: hidden; border-left-style: hidden; border-right-style: hidden; font-family: 'Times New Roman', Times, serif; text-align: center;">
                    <option value="Ca0001">Tiết 1 - Tiết 5(6h30 - 10h50)</option>
                    <option value="Ca0002">Tiết 6 - Tiết 10(10h50 - 16h)</option>
                    <option value="Ca0003">Tiết 11 - Tiết 15(16h50 - 19h50)</option>
                </select><br>
                <select name="form-khoahoc" id="form-khoahoc" style="height: 40px; min-width: 400px; margin-top: 40px; border: 3px double navy; border-top-style: hidden; border-left-style: hidden; border-right-style: hidden; font-family: 'Times New Roman', Times, serif; text-align: center;">
                    <option value="<?php echo $p->laycot("SELECT MaKH From khoahoc LIMIT 1;");?>"><?php echo $p->laycot("SELECT TenKH From khoahoc LIMIT 1;") ?></option>
                    <option value="<?php echo $p->laycot("SELECT MaKH From khoahoc LIMIT 2;");?>"><?php echo $p->laycot("SELECT TenKH From khoahoc LIMIT 2;") ?></option>
                    <option value="<?php echo $p->laycot("SELECT MaKH From khoahoc LIMIT 3;");?>"><?php echo $p->laycot("SELECT TenKH From khoahoc LIMIT 3;") ?></option>
                </select><br>
                <?php
                    $p->load_selectionGV("SELECT * FROM giangvien");
                ?><br>
                <?php
                    $p->load_selectionPH("SELECT * FROM phonghoc");
                ?><br>
                <input type="date" id="form-ngaybd" name="form-ngaybd" style="height: 40px; min-width: 400px; margin-top: 40px; border: 3px double navy; border-top-style: hidden; border-left-style: hidden; border-right-style: hidden; font-family: 'Times New Roman', Times, serif; text-align: center;"><br>
                <input type="date" id="form-ngaykt" name="form-ngaykt" style="height: 40px; min-width: 400px; margin-top: 40px; border: 3px double navy; border-top-style: hidden; border-left-style: hidden; border-right-style: hidden; font-family: 'Times New Roman', Times, serif; text-align: center;"><br>
                <input type="submit" value="Tạo Lớp Học" id="btn-suathongtin" name="btn-suathongtin" class="btn btn-primary float-left">
                <input type="reset" value="Reset form" id="btn-xoa" name="btn-suathongtin" class="btn btn-primary float-right">
            </form>
                <?php
                    			switch($_POST['btn-suathongtin'] ?? null)
                                {
                                    case 'Tạo Lớp Học':
                                    {
                                        $malh = $_REQUEST['form-malophoc'];
                                        $tenlh = $_REQUEST['form-tenlophoc'];
                                        $siso = $_REQUEST['form-siso'];
                                        $cahoc = $_REQUEST['form-cahoc'];
                                        $khoahoc = $_REQUEST['form-khoahoc'];
                                        $giangvien = $_REQUEST['form-giangvien'];
                                        $phonghoc = $_REQUEST['form-phonghoc'];
                                        $ngaybd = $_REQUEST['form-ngaybd'];
                                        $ngaykt = $_REQUEST['form-ngaykt'];
                                        if($malh != '' && $tenlh != '' && $siso != '' && $cahoc != '' && $khoahoc != '' && $giangvien != '' && $ngaybd != '' && $ngaykt != '')
                                        {
                                            if($p->themxoasua("INSERT INTO lophoc(MaLH,TenLopHoc,Siso,MaCaHoc,MaKH,MaGV,MaPH,NgayBD,NgayKT) VALUES('$malh','$tenlh','$siso','$cahoc','$khoahoc','$giangvien','$phonghoc','$ngaybd','$ngaykt')")==1)
                                            {
                                                echo '<script> alert("Thêm lớp học mới thành công thành công");</script>';
                                                header( "refresh:0;url=quanlylophoc.php" );
                                            }
                                            else
                                            {
