  ...
  <div class="content-wrapper" style="min-height: 534px;">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Danh sách lịch học của các lớp</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <a href="Themlichhoc.php" class="btn btn-primary float-right">Thêm lịch học</a>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row">
          <!-- Left col -->
          <?php
            $p ->load_dslichhoc("SELECT * FROM `view_qllichhoc`");
        ?>
          <!-- /.Left col -->
