    ...
    <div class="row">
          <div class="col-lg-6 col-6">
            ...
            <div class="small-box bg-info">
              ...
              <a href="Xeplichthi.php" class="small-box-footer">Xem<i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-6 col-6">
            ...
            <div class="small-box bg-success">
              ...
              <a href="Ketquathi.php" class="small-box-footer">Xem<i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
        </div>
