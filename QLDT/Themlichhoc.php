          ...
          <section class="col-lg-12 connectedSortable ui-sortable">
            ...
            <div class="card">
              ...
              <form action="" method="post">
                <caption><strong style="color: deepskyblue;text-align: center; padding-top: 40px;padding-bottom: 40px; font-size: 30px; font-family: 'Times New Roman', Times, serif; text-indent: 20px;">THÊM LỊCH HỌC</strong></caption><br>
                <input type="text" name="form-malichthi" id="form-malichthi" placeholder="Mã Lịch Hoc. VD: LH0001" style="text-align: center; height: 40px; min-width: 400px; margin-top: 40px; border: 3px double navy; border-top-style: hidden; border-left-style: hidden; border-right-style: hidden; font-family: 'Times New Roman', Times, serif; text-align: center;"><br>
                <?php
                ...
                <?php
                    			switch($_POST['btn-suathongtin'] ?? null)
                                {
                                    case 'Tạo Lớp Học':
                                    {
                                        $malh = $_REQUEST['form-malichthi'];
                                        $tenlh = $_REQUEST['form-tenlophoc'];
                                        $phonghoc = $_REQUEST['form-phonghoc'];
                                        $cahoc = $_REQUEST['form-giothi'];
                                        if($malh != '' && $tenlh != '' && $phonghoc != '' && $cahoc != '')
                                        {
                                            if($p->themxoasua("INSERT INTO lichhoc(MaLichHoc,MaCaHoc,MaLH,MaPH) VALUES('$malh','$cahoc','$tenlh','$phonghoc')")==1)
                                            {
                                                echo '<script> alert("Thêm lich hoc thành công");</script>';
                                            }
                                            else
                                            {
                                                echo '<script> alert("Thêm lich hoc không thành công. Vui lòng kiểm tra lại thông tin lich thi");</script>';
                                            }
                                        }
                                        else
                                        {
                                            echo '<script> alert("Vui lòng nhập đầy đủ thông tin lịch học");</script>';
                                        }
                                        break;
                                    }
