      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            <a href="indexgiangvien.php" class="nav-link active">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="ThongtinGV.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Xem thông tin</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="Xemlichday.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Xem lịch dạy</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="Danhsachlophoc.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Xem danh sách lớp</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="Uploadstailieuhocvien.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Upload tài liệu</p>
                </a>
              </li>
  ...
  <div class="content-wrapper" style="min-height: 534px;">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1 class="m-0" style="text-align: center;">Xem Thông tin <?php echo $p->laycot("SELECT VaiTro FROM taikhoan WHERE MaTK = '$layid_dangnhap' LIMIT 1");?></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
          </div><!-- /.col -->
        </div><!-- /.row -->
          ...
          <section class="col-lg-12 connectedSortable ui-sortable">
            ...
            <div class="card">
              ...
              <figure class="snip1559">
                    <div class="profile-image"><img src="../dist/img/user2-160x160.jpg" alt="profile-sample2" /></div>
                    <figcaption>
                        <h3><?php echo $p->laycot("SELECT TenGV FROM giangvien WHERE MaGV = '$layid_dangnhap' LIMIT 1"); ?></h3>
                        <h5><?php echo $p->laycot("SELECT VaiTro FROM taikhoan WHERE MaTK = '$layid_dangnhap' LIMIT 1");?></h5>
                        <p>Ngày sinh: <?php echo $p->laycot("SELECT NgaySinh FROM giangvien WHERE MaGV = '$layid_dangnhap' LIMIT 1"); ?></p>
                        <p>Quê quán: <?php echo $p->laycot("SELECT DiaChi FROM giangvien WHERE MaGV = '$layid_dangnhap' LIMIT 1"); ?> </p>
                        <p>Email: <?php echo $p->laycot("SELECT Email FROM giangvien WHERE MaGV = '$layid_dangnhap' LIMIT 1"); ?></p>
                        <div class="icons"><a href="#"><i class="ion-social-yahoo"></i></a>
