  ...
  <div class="content-wrapper" style="min-height: 534px;">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0"><?php echo $p->laycot("SELECT VaiTro FROM taikhoan WHERE MaTK = '$layid_dangnhap' LIMIT 1");?></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
          </div><!-- /.col -->
        </div><!-- /.row -->
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              <div class="inner">
                ...
                <p><?php echo $p->laycot("SELECT TenDangNhap FROM taikhoan WHERE MaTK = '$layid_dangnhap' LIMIT 1");?></p>
              </div>
              <a href="ThongtinGV.php" class="small-box-footer">Xem danh sách <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              ...
              <a href="Xemlichday.php" class="small-box-footer">Xem danh sách <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-warning">
              <div class="inner">
                <h4>Xem danh sách lớp</h4>

                <p><?php echo $p->laycot("SELECT TenDangNhap FROM taikhoan WHERE MaTK = '$layid_dangnhap' LIMIT 1");?></p>
              </div>
              <a href="Danhsachlophoc.php" class="small-box-footer">Xem danh sách <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-danger">
              ...
              <a href="Uploadstailieuhocvien.php" class="small-box-footer">Xem danh sách<i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
        </div>
        ...
        <div class="row">
          ...
          <section class="col-lg-12 connectedSortable ui-sortable">
            ...
            <div class="card">
              ...
              <div class="row">
                <?php 
                  $p ->load_dslophocGV("SELECT * FROM lophoc WHERE MaGV = '$layid_dangnhap' order by MaLH ASC");
                ?>
              </div>
              <!-- /.card-body -->
            </div>
