  ...
  <div class="content-wrapper" style="min-height: 534px;">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0"><?php echo $p->laycot("SELECT VaiTro FROM taikhoan WHERE MaTK = '$layid_dangnhap' LIMIT 1");?> <?php echo $p->laycot("SELECT TenGV FROM giangvien WHERE MaGV = '$layid_dangnhap' LIMIT 1"); ?></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
          </div><!-- /.col -->
        </div><!-- /.row -->
        ...
        <div class="row">
          ...
          <section class="col-lg-12 connectedSortable ui-sortable">
            ...
            <div class="card">
              ...
              <div class="row">
                <?php
                    $p->load_dslichday("SELECT * FROM `view_xemlichday` WHERE MaGV = '$layid_dangnhap' GROUP BY MaLichHoc");
                ?> 
              </div>
              <!-- /.card-body -->
            </div>
